        ...
        <div className='sm:pb-10'>
          ...
          <div className="flex flex-col py-10 gap-5">
            <div className="flex items-center gap-5">
              ...
              <div>
              <a href='tel://+917639591469' >+917639591469 , </a>
              <a href='tel://+918778813712'> +918778813712 , </a>
              <a href='tel://+919566644905'>+919566644905</a>
              </div>
            </div>
            <div className="flex items-center gap-5 ">
              <svg
            ...
            <div className="flex items-center gap-5">
              ...
              <a href='mailto://sgttoursandtravels2025@gmail.com'>sgttoursandtravels2025@gmail.com</a>
            </div>
          </div>
          ...
          <div className='flex justify-center items-center h-8 w-8 hover:bg-white bg-gray-500 rounded-full'>
          <a className='flex justify-center' href='https://www.instagram.com/santhosh_s69/'><box-icon  type='logo' name='instagram' ></box-icon></a>
